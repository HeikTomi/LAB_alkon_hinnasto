    ...
    public function render($data, $totalPages, $currentPage, $types, $countries) {
        ...
        $formHtml = '<form method="GET" action="" class="mb-4">
            ...
            <div class="mb-3">
                ...
                <div class="slider-container">
                    <input type="range" id="priceMin" class="slider form-range" name="priceMin" min="0" max="100000" step="0.01" value="' . htmlspecialchars($priceMin) . '">
                    <input type="range" id="priceMax" class="slider form-range" name="priceMax" min="0" max="100000" step="0.01" value="' . htmlspecialchars($priceMax) . '">
                </div>
